...
metric.qc <- function(fun.DF){##FUNCTION.metric.qc.START
  # define pipe
  `%>%` <- dplyr::`%>%`
  # Munge ####
  ...
  if(num.col.req.missing!=0 & interactive()==TRUE){##IF.num.col.req.missing.START
    ...
    myPrompt.04 <- "Therefore, the shiny app has stopped functioning - please add these fields."
