...
-   Update MacroinvertebrateRating field that comes out with scores to EGLE thresholds. Based on 5th percentile of reference for each site class.
    
# EGLEtools 2.0.0 (2025-12-15)
-   Update to version 2.0.0 by finishing changes representing EGLE 2025 models.
...
-   Updated to incorporate BioMonTools fix for incorrect metric scoring calc.
...
-   Updated site classification to function by sampleid to avoid duplicates.
...
-   Added and tested metric calc, metric scoring, and index scoring functionality
